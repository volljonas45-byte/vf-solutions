...
export const T = {
  de: {
    ...
    projekte: {
      ...
      areasEyebrow: "Projektbereiche",
      areasTitle: "Typische Projektschwerpunkte",
      areasLead:
        "vf solutions unterstützt Unternehmen dort, wo CAD- und PDM-Prozesse stabiler, nachvollziehbarer und besser integrierbar werden sollen — Hauptschwerpunkt: Migration.",
      vorgehen: "Vorgehen",
      nutzen: "Nutzen",
      focusBadge: "Schwerpunkt",
  ...
  en: {
    ...
    projekte: {
      ...
      areasEyebrow: "Project areas",
      areasTitle: "Typical project focus",
      areasLead:
        "vf solutions supports companies where CAD and PDM processes need to become more stable, traceable and better integrated — main focus: migration.",
      vorgehen: "Approach",
      nutzen: "Benefit",
      focusBadge: "Core focus",
